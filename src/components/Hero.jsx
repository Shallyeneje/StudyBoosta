    ...
    <>
      ...
      <div className="d-flex  justify-content-center align-items-center">
        <div className="col-2 d-flex flex-column justify-content-center">
          <img src={Group_1} className="img-fluid deco" alt="Background Decoration" style={{ marginRight: '5px' }} />
        </div>
        <div className="col-6 ">
          <h1 className="hero-text">Find the best <span className="s-course"><i>Courses</i></span></h1>
      ...
      <div className="container mb-0">
        ...
        <div>
          <img src= { Ellipse_3} className="background-image" alt="Background Decoration" />
        </div>
      </div>
    </div>
    </>
